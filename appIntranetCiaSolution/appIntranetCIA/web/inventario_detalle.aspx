                            ...
                            <div class="content">
                                    ...
                                    <asp:Panel ID="pnAlmancen" runat="server" Visible="false">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Codigo :</label>
                                                <asp:TextBox runat="server" ID="TextBox1" ReadOnly="true" style="background-color:lightgray;border-top:solid 2px gray;border-left:solid 2px gray" CssClass="form-control"></asp:TextBox>                                                
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label>Descripcion :</label>
                                                <asp:TextBox runat="server" ID="TextBox2" style="text-transform:uppercase"  AutoCompleteType="Disabled" CssClass="form-control"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Peso Kg. :</label>
                                                <asp:TextBox runat="server" ID="TextBox3"  style="text-align:right" onKeyPress="return checkIt(event)" AutoCompleteType="Disabled" Text="0.00" CssClass="form-control"></asp:TextBox>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Estado : </label>
                                                <asp:DropDownList runat="server" Enabled="false" CssClass="form-control" ID="DropDownList4">                                                    
                                                    <asp:ListItem Value="1" Selected="True">Activo</asp:ListItem>
                                                    <asp:ListItem Value="2">Descontinuado</asp:ListItem>
                                                </asp:DropDownList>
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Fecha Registro :</label>
                                                <asp:Label runat="server" ID="Label1" Enabled="false" CssClass="form-control"></asp:Label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="btn-fill pull-right">
                                        <table>
                                            <tr>
                                                <td>
                                                     <asp:Button runat="server" ID="Button1" CssClass="btn btn-info btn-fill pull-righ" Text="GUARDAR" OnClick="btn_Guardar_Click"  />
                                                </td>
                                                <td>
                                                    &nbsp;
                                                    &nbsp;
                                                ...
                                                <td>
                                                    <asp:Button  runat="server" CssClass="btn btn-danger btn-fill pull-right" Text="CANCELAR" ID="Button2" OnClick="btn_Cancelar_Click" />
                                                </td>
                                            </tr>
